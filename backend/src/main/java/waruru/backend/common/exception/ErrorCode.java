...
public enum ErrorCode {
    ...
    EMPTY_SALE_NAME(400,"SA_003", "빈 매물 이름입니다."),
    INVALID_SALE_NAME(400,"SA_004", "매물의 이름은 공백일 수 없습니다."),

    NOT_FOUND_DETAIL(404, "DE_001", "존재하지 않는 납부 내역입니다."),
    DUPLICATED_DETAIL_NAME(400, "DE_002", "이미 존재하는 납부 내역 이름입니다."),
    EMPTY_DETAIL_NAME(400,"DE_003", "빈 납부 내역 이름입니다."),
    INVALID_DETAIL_NAME(400,"DE_004", "납부 내역의 이름은 공백일 수 없습니다."),

    NOT_FOUND_BUSINESS(404, "BU_001", "존재하지 않는 거래입니다."),
    DUPLICATED_BUSINESS_NAME(400, "BU_002", "이미 존재하는 거래 이름입니다."),
    EMPTY_BUSINESS_NAME(400,"BU_003", "빈 거래 이름입니다."),
    INVALID_BUSINESS_NAME(400,"BU_004", "거래의 이름은 공백일 수 없습니다."),

    NOT_FOUND_REVIEW(404, "RE_001", "존재하지 않는 리뷰입니다."),
    DUPLICATED_REVIEW_NAME(400, "RE_002", "이미 존재하는 리뷰 이름입니다."),
    EMPTY_REVIEW_NAME(400,"RE_003", "빈 리뷰 이름입니다."),
